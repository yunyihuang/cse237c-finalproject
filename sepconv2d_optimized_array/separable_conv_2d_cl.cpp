...
void depthwise_conv_2d_cl(
	...
	{
#pragma HLS array_partition variable=data cyclic factor=64
#pragma HLS array_partition variable=depthwise_weights cyclic factor=64
#pragma HLS array_partition variable=depthwise_res cyclic factor=64
...
void pointwise_conv_2d_latency_cl(
	...
	{
#pragma HLS array_partition variable=depthwise_res cyclic factor=64
#pragma HLS array_partition variable=pointwise_weights cyclic factor=64
#pragma HLS array_partition variable=res cyclic factor=64
